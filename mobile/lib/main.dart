...
void main() async {
  ...
  try {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: 'AIzaSyBDTB7F4rDu8yXh1RFsoECW27xw2In2xuo',
        appId: '1:1234567890:android:mock_app_id', // Mock app ID, modify later if needed
        messagingSenderId: 'default_sender_id',
        projectId: 'gl-and-fms',
        databaseURL: 'https://gl-and-fms-default-rtdb.firebaseio.com',
      ),
    );
  } catch (e) {
  ...
  runApp(const GLFLMSApp());
}

class GLFLMSApp extends StatelessWidget {
  const GLFLMSApp({super.key});
